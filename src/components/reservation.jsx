...
const TimeRangeSlider = ({
    ...
    useEffect(() => {
        const isInitialRender = startTime.hour === 0 && startTime.minute === 0 &&
    ...
    }, [isDragging, isDraggingStart, isDraggingEnd, startTime, endTime, onStartTimeChange, onEndTimeChange, isToday]);
    ...
    return (
        <div className="relative h-32 mb-4">
            <div className="absolute top-0 w-full flex justify-between px-1 text-xs text-gray-500">
                {timeMarkers.map((marker, i) => (
                    <div
                        ...
                        className={`flex flex-col items-center ${marker.isHour ? 'font-medium' : 'text-gray-400'}`}
                    >
            ...
            <div
                ref={sliderRef}
                className="absolute inset-x-0 top-10 h-4 bg-gray-200 rounded-full"
            >
                {isToday && (
                    <div
            ...
            <div className="absolute top-20 left-0 right-0 text-center">
                <div
                    className="inline-block bg-blue-100 px-4 py-2 rounded-full text-sm font-medium text-blue-800 shadow-sm">
                    ...
                    <span className="text-blue-600 ml-2 font-bold">
                      ({Math.round((endTime.hour * 60 + endTime.minute) - (startTime.hour * 60 + startTime.minute))} мин)
                    </span>
                </div>
            </div>
        </div>
        ...
        >
            ...
            >
                <svg width="600" height="400" viewBox="0 0 600 400" className="mx-auto">
                    ...
                    {/* Фон */}
                    <rect x="10" y="10" width="580" height="380" rx="5" fill="#f8fafc" stroke="#94a3b8" strokeWidth="2" />

                    {/* фон коридоров */}
                    <rect x="20" y="20" width="580" height="380" rx="5" fill="#f8fafc" stroke="none" />

                    {/* Вертикальный коридор слева */}
                    <rect x="215" y="20" width="10" height="360" fill="#e5e7eb" stroke="#d1d5db" strokeWidth="1" />
                    ...
                    <rect x="435" y="20" width="10" height="360" fill="#e5e7eb" stroke="#d1d5db" strokeWidth="1" />
                    ...
                    <rect x="20" y="205" width="570" height="10" fill="#e5e7eb" stroke="#d1d5db" strokeWidth="1" />
                    ...
                    {/* Зона A: Опен-спейс */}
                    <rect x="20" y="20" width="190" height="180" rx="3" fill="#eff6ff" stroke="#3b82f6" strokeWidth="1" strokeDasharray="5,3" />
                    <text x="30" y="40" fill="#1e40af" fontSize="12" fontWeight="bold">Зона A: Опен-спейс</text>


                    {/* Зона B: Кабинеты */}
                    <rect x="230" y="20" width="200" height="180" rx="3" fill="#f0fdfa" stroke="#14b8a6" strokeWidth="1" />
                    <text x="240" y="40" fill="#0f766e" fontSize="12" fontWeight="bold">Зона B: Кабинеты</text>


                    {/* Столы в кабинетах */}
                    <rect x="260" y="50" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />
                    <rect x="310" y="50" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />
                    <rect x="360" y="50" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />
                    <rect x="260" y="100" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />
                    <rect x="310" y="100" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />
                    <rect x="360" y="100" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />
                    <rect x="260" y="150" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />
                    <rect x="310" y="150" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />
                    <rect x="360" y="150" width="40" height="30" rx="2" fill="none" stroke="#0f766e" strokeWidth="1" />


                    {/* Зона C: Переговорные */}
                    <rect x="20" y="220" width="190" height="160" rx="3" fill="#fef9c3" stroke="#ca8a04" strokeWidth="1" />
                    <text x="30" y="240" fill="#854d0e" fontSize="12" fontWeight="bold">Зона C: Переговорные</text>


                    {/* Столы в переговорных */}
                    <rect x="53" y="265" width="45" height="30" rx="2" fill="none" stroke="#ca8a04" strokeWidth="1" />
                    <rect x="133" y="265" width="45" height="30" rx="2" fill="none" stroke="#ca8a04" strokeWidth="1" />
                    <rect x="53" y="310" width="45" height="30" rx="2" fill="none" stroke="#ca8a04" strokeWidth="1" />
                    <rect x="133" y="310" width="45" height="30" rx="2" fill="none" stroke="#ca8a04" strokeWidth="1" />


                    {/* Зона D: Тихая зона */}
                    <rect x="240" y="220" width="190" height="160" rx="3" fill="#fae8ff" stroke="#a855f7" strokeWidth="1" />
                    <text x="250" y="240" fill="#7e22ce" fontSize="12" fontWeight="bold">Зона D: Тихая зона</text>


                    {/* Зона E: Зона отдыха */}
                    <rect x="450" y="20" width="130" height="180" rx="3" fill="#dcfce7" stroke="#22c55e" strokeWidth="1" />
                    <text x="460" y="40" fill="#15803d" fontSize="12" fontWeight="bold">Зона E: Зона отдыха</text>


                    {/* Кофе-зона */}
                    <rect x="450" y="220" width="130" height="160" rx="3" fill="#ffedd5" stroke="#f97316" strokeWidth="1" />
                    <text x="460" y="240" fill="#c2410c" fontSize="12" fontWeight="bold">Кофе-зона</text>


                    {/* Кофемашина */}
                    <rect x="470" y="260" width="30" height="15" rx="2" fill="#fdba74" stroke="#c2410c" strokeWidth="1" />
                    <text x="485" y="270" fill="#7c2d12" fontSize="7" textAnchor="middle">Кофе</text>
                    ...
                    {/* Туалеты */}
                    <rect x="490" y="300" width="25" height="20" rx="2" fill="#e2e8f0" stroke="#64748b" strokeWidth="1" />
                    <text x="502" y="315" fill="#334155" fontSize="8" textAnchor="middle">WC</text>
                    <rect x="525" y="300" width="25" height="20" rx="2" fill="#e2e8f0" stroke="#64748b" strokeWidth="1" />
                    <text x="537" y="315" fill="#334155" fontSize="8" textAnchor="middle">WC</text>
                    ...
                    <text x="228" y="80" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 228 80)">→ Зоны A, B</text>
                    <text x="228" y="160" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 228 160)">→ Зона E</text>
                    <text x="228" y="260" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 228 260)">→ Зоны C, D</text>
                    <text x="228" y="340" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 228 340)">→ Кофе-зона</text>

                    <text x="452" y="80" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 452 80)">→ Зона E</text>
                    <text x="452" y="260" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 452 260)">→ Кофе-зона</text>
                    <text x="452" y="340" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 452 340)">→ Туалеты</text>

                    <text x="120" y="202" fill="#6b7280" fontSize="8" fontWeight="500">→ Зона C</text>
                    <text x="300" y="202" fill="#6b7280" fontSize="8" fontWeight="500">→ Зона D</text>
                    <text x="500" y="202" fill="#6b7280" fontSize="8" fontWeight="500">→ Кофе-зона</text>
                    ...
                    <text x="220" y="375" fill="#475569" fontSize="8" textAnchor="middle">ВХОД</text>
                    ...
                    {seats.map(seat => (
                        ...
                        >
                            <rect
                                ...
                                height="18"
                                rx="2"
                                fill={selectedSeat?.id === seat.id ? '#bfdbfe' : seat.isOccupied ? '#f3f4f6' : seat.type === 'desk' ? '#dbeafe' : seat.type === 'office' ? '#ccfbf1' : seat.type === 'meeting' ? '#fef9c3' : seat.type === 'focus' ? '#fae8ff' : '#dcfce7'}
                                stroke={selectedSeat?.id === seat.id ? '#3b82f6' : seat.isOccupied ? '#d1d5db' : seat.type === 'desk' ? '#60a5fa' : seat.type === 'office' ? '#2dd4bf' : seat.type === 'meeting' ? '#facc15' : seat.type === 'focus' ? '#d946ef' : '#4ade80'}
                                strokeWidth="1"
                                data-seat="true"
                            />
                            <text
                                ...
                                fontSize="7"
                                fontWeight="500"
                                fill={seat.isOccupied ? '#9ca3af' : seat.type === 'desk' ? '#1e40af' : seat.type === 'office' ? '#0f766e' : seat.type === 'meeting' ? '#854d0e' : seat.type === 'focus' ? '#7e22ce' : '#15803d'}
                                data-seat="true"
                            >
                                {seat.name}
                            </text>
...
const CoworkingBooking = () => {
    ...
    useEffect(() => {
        if (popoverSeat) {
            const updatePopoverPosition = () => {
                const mapContainer = document.querySelector('.coworking-map-container');
                if (mapContainer) {
    ...
    const handleBooking = () => {
        alert(`Место ${selectedSeat.name} забронировано на ${formatDate(selectedDate)} с ${formatTime(timeRange.start)} до ${formatTime(timeRange.end)}`);
        setPopoverSeat(null);
    };
    ...
    const getBookingDuration = () => {
        const startMins = timeRange.start.hour * 60 + timeRange.start.minute;
        const endMins = timeRange.end.hour * 60 + timeRange.end.minute;
            ...
            {selectedSeat && (
                <div className="bg-white rounded-xl shadow-lg p-6">
                    <div className="flex items-center mb-6">
                        ...
                        <h2 className="text-xl font-semibold text-gray-900">Информация о бронировании</h2>
                    </div>
                        ...
                        <div>
                            <div className="p-4 bg-blue-50 rounded-lg">
                                <div className="flex items-center gap-3 mb-4">
                                    {getSeatTypeInfo(selectedSeat.name).icon}
                                    <div>
                                        <h3 className="font-semibold text-gray-900">{getSeatTypeInfo(selectedSeat.name).name} {selectedSeat.name}</h3>
                                        <p className="text-sm text-gray-600">{getSeatTypeInfo(selectedSeat.name).description}</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3 mt-6">
                                    <div className="flex items-start gap-2 text-gray-600">
                                        ...
                                        <span className="text-sm">Доступ к кофе-зоне без ограничений</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-gray-600">
                                        <Wifi className="w-4 h-4 text-blue-600 mt-0.5"/>
                                        <span className="text-sm">Wi-Fi 100 Мбит/с, без ограничений трафика</span>
                                    </div>
                                    <div className="flex items-start gap-2 text-gray-600">
                                        <Users className="w-4 h-4 text-blue-600 mt-0.5"/>
                                        <span className="text-sm">До {selectedSeat.name.startsWith('B') || selectedSeat.name.startsWith('C') ? '4' : '1'} человек</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="p-4 bg-gray-50 rounded-lg">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium text-gray-900">{formatTime(timeRange.start)} - {formatTime(timeRange.end)}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-600">Продолжительность:</span>
                                        <span className="font-medium text-gray-900">{getBookingDuration()}</span>
                                    </div>
                                    ...
                                    <div className="border-t border-gray-200 my-3 pt-3">
                                        <div className="flex justify-between font-medium">
                                            ...
                                            <span className="text-gray-900">
                                                {Math.round((timeRange.end.hour * 60 + timeRange.end.minute - (timeRange.start.hour * 60 + timeRange.start.minute)) / 15) *
                                                    (selectedSeat.name.startsWith('B') ? 200 : selectedSeat.name.startsWith('C') ? 300 : 100)} ₽
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-4">
                                ...
                                <button
                                    ...
                                    className="w-full mt-3 py-2 px-4 bg-white border border-gray-300 hover:bg-gray-100 text-gray-700 font-medium rounded-lg transition-colors"
                                >
                                    Отмена
                                </button>
                            </div>
