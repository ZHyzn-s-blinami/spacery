...
const SeatPopover = ({seat, timeRange, selectedDate, onClose, onBook, position}) => {
    ...
    return (
        <div
            ref={popoverRef}
            className={`fixed z-50 w-72 bg-white border border-gray-200 rounded-lg shadow-lg transition-all duration-200 ${mounted ? 'opacity-100' : 'opacity-0'}`}
            style={{
                left: `${position.x}px`,
            ...
            <div className="px-4 py-3">
                <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-gray-500">
                        ...
                        <span
                            className="text-sm">До {seat.name.startsWith('B') || seat.name.startsWith('C') ? '4' : '1'} человека</span>
                    </div>
                    <div className="bg-blue-50 p-3 rounded">
                        <div className="flex justify-between text-sm text-gray-700">
                            <span>Время:</span>
                            <span
                                className="font-medium">{formatTime(timeRange.start)} - {formatTime(timeRange.end)}</span>
                        </div>
        ...
        >
            ...
            >
                <svg width="600" height="400" viewBox="0 0 600 400" className="mx-auto">
                    ...
                    {/* Фон */}
                    <rect x="10" y="10" width="580" height="380" rx="5" fill="#f8fafc" stroke="#94a3b8"
                          strokeWidth="2"/>
                    ...
                    {/* Зона A: Опен-спейс */}
                    <rect x="20" y="20" width="190" height="180" rx="3" fill="#eff6ff" stroke="#3b82f6" strokeWidth="1"
                          strokeDasharray="5,3"/>
                    <text x="30" y="40" fill="#1e40af" fontSize="12" fontWeight="bold">Зона A: Опен-спейс</text>


                    {/* Зона B: Кабинеты */}
                    <rect x="230" y="20" width="200" height="180" rx="3" fill="#f0fdfa" stroke="#14b8a6"
                          strokeWidth="1"/>
                    ...
                    {/* Зона C: Переговорные */}
                    <rect x="20" y="220" width="190" height="160" rx="3" fill="#fef9c3" stroke="#ca8a04"
                          strokeWidth="1"/>
                    ...
                    {/* Зона D: Тихая зона */}
                    <rect x="240" y="220" width="190" height="160" rx="3" fill="#fae8ff" stroke="#a855f7"
                          strokeWidth="1"/>
                    <text x="250" y="240" fill="#7e22ce" fontSize="12" fontWeight="bold">Зона D: Тихая зона</text>


                    {/* Зона E: Зона отдыха */}
                    <rect x="450" y="20" width="130" height="180" rx="3" fill="#dcfce7" stroke="#22c55e"
                          strokeWidth="1"/>
                    <text x="460" y="40" fill="#15803d" fontSize="12" fontWeight="bold">Зона E: Зона отдыха</text>


                    {/* Кофе-зона */}
                    <rect x="450" y="220" width="130" height="160" rx="3" fill="#ffedd5" stroke="#f97316"
                          strokeWidth="1"/>
                    <text x="460" y="240" fill="#c2410c" fontSize="12" fontWeight="bold">Кофе-зона</text>


                    {/* Кофемашина */}
                    <rect x="470" y="260" width="30" height="15" rx="2" fill="#fdba74" stroke="#c2410c"
                          strokeWidth="1"/>
                    ...
                    {/* Туалеты */}
                    <rect x="490" y="300" width="25" height="20" rx="2" fill="#e2e8f0" stroke="#64748b"
                          strokeWidth="1"/>
                    <text x="502" y="315" fill="#334155" fontSize="8" textAnchor="middle">WC</text>
                    <rect x="525" y="300" width="25" height="20" rx="2" fill="#e2e8f0" stroke="#64748b"
                          strokeWidth="1"/>
                    ...
                    <text x="228" y="80" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 228 80)">→
                        Зоны A, B
                    </text>
                    <text x="228" y="160" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 228 160)">→
                        Зона E
                    </text>
                    <text x="228" y="260" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 228 260)">→
                        Зоны C, D
                    </text>
                    <text x="228" y="340" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 228 340)">→
                        Кофе-зона
                    </text>

                    <text x="452" y="80" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 452 80)">→
                        Зона E
                    </text>
                    <text x="452" y="260" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 452 260)">→
                        Кофе-зона
                    </text>
                    <text x="452" y="340" fill="#6b7280" fontSize="8" fontWeight="500" transform="rotate(90 452 340)">→
                        Туалеты
                    </text>
                    ...
                    {seats.map(seat => (
                        ...
                        >
                            <rect
                                ...
                                stroke={selectedSeat?.id === seat.id ? '#3b82f6' : seat.isOccupied ? '#d1d5db' : seat.type === 'desk' ? '#60a5fa' : seat.type === 'office' ? '#2dd4bf' : seat.type === 'meeting' ? '#facc15' : seat.type === 'focus' ? '#d946ef' : seat.type === 'focus' ? '#d946ef' : '#4ade80'}
                                strokeWidth="1"
                                data-seat="true"
                            />
                            <text
