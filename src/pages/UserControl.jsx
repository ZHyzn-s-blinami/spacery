                          ...
                          <div className={`grid transition-all duration-300 ease-in-out ${
                            ...
                            <div className="overflow-hidden min-h-0">
                              <div className={`space-y-3 p-3 rounded-lg bg-gray-50 border border-gray-100 mb-3 transition-opacity duration-300 ${
                                ...
                                <div className="text-xs text-gray-600">
                                  <span className="font-medium">Верифицирован:</span> {user.verified ? 'Да' : 'Нет'}
                                </div>
                                <div className="text-xs text-gray-600">
                                  <span className="font-medium">Создан:</span> {formatDate(user.createdAt)} в {formatTime(user.createdAt)}
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            {[
                              ...
                              { id: 'actions', label: 'Действия' },
                                ...
                                >
                                  ...
                                  >
                                    <div className="w-0.5 h-4/5 bg-gray-300 group-hover:bg-blue-500"></div>
                                  </div>
                                </th>
                            ))}
                          </tr>
