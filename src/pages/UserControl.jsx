        ...
        <div className="min-h-screen bg-gray-50">
                            ...
                            <div className="overflow-hidden min-h-0">
                                <div className="pt-4 border-t border-gray-200">
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            <label
                                                className="block text-sm font-medium text-gray-700 mb-1">Статус</label>
                                            <select
                                                name="status"
                                                className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                                        ...
                                        <div>
                                            <label
                                                className="block text-sm font-medium text-gray-700 mb-1">Верификация</label>
                                            <select
                                                name="verified"
                                                className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                                            ...
                                            <div className="relative w-4 h-4 flex items-center justify-center">
                                                <ChevronDown size={14}
                                                             className={`absolute transition-transform duration-300 ease-in-out ${
                                                                 expandedUsers[user.id] ? 'opacity-0 transform rotate-180' : 'opacity-100'
                                                             }`}
                                                />
                                                <ChevronUp size={14}
                                                           className={`absolute transition-transform duration-300 ease-in-out ${
                                                               expandedUsers[user.id] ? 'opacity-100' : 'opacity-0 transform -rotate-180'
                                                           }`}
                                                />
                                            </div>
                                        </button>
                                            ...
                                            <div className="overflow-hidden min-h-0">
                                                <div
                                                    ...
                                                    {user.description && (
                                                        <div className="text-xs text-gray-600">
                                                            <span
                                                                className="font-medium">Описание:</span> {user.description}
                                                        </div>
                                                    )}
                                                    <div className="text-xs text-gray-600">
                                                        <span
                                                            className="font-medium">Верифицирован:</span> {user.verified ? 'Да' : 'Нет'}
                                                    </div>
                                                    <div className="text-xs text-gray-600">
                                                        <span
                                                            className="font-medium">Создан:</span> {formatDate(user.createdAt)} в {formatTime(user.createdAt)}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="bg-white shadow-md rounded-lg overflow-hidden hidden lg:block">
                            {currentUsers.length > 0 ? (
                                <div className="overflow-x-auto">
                                            ...
                                            <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                                                <td className="px-3 py-3">
                                                    <div className="flex items-start">
                                                        <div
                                                            className="flex-shrink-0 h-8 w-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center">
                                                ...
                                                <td className="px-4 py-3 relative">
                                                    {user.description ? (
                                                        <div>
                                                            ...
                                                            {user.description.length > 50 && (
                                                                ...
                                                                >
                                                                    ...
                                                                    <div
                                                                        className="relative w-4 h-4 ml-0.5 flex items-center justify-center">
                                                                        <ChevronDown
                                                                            className={`absolute transition-transform duration-300 ease-in-out h-3 w-3 ${
                                                                                expandedUsers[`desc_${user.id}`] ? 'transform rotate-180' : ''
                                                                            }`}
                                                                        />
                                                                    </div>
                                                                </button>
                                                        ...
                                                        <span
                                                            className="text-sm text-gray-400 italic">Нет описания</span>
                                                    )}
                                                </td>
                                  ...
                                  <span
                                      className={`px-2 py-1 rounded-full text-xs font-medium ${getRoleClass(user.role)}`}>
                                    ...
                                    <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                        <div>
                                            <p className="text-sm text-gray-700">
                                                Показаны записи с <span
                                                className="font-medium">{indexOfFirstUser + 1}</span>{' '}
                                                по{' '}
                                                <span
                                                    className="font-medium">{Math.min(indexOfLastUser, filteredUsers.length)}</span>{' '}
                ...
                >
                    <div
                        className={`bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 transform transition-all duration-300 ease-in-out ${
                            editModalClosing ? 'scale-95 opacity-0' :
                                editModalAppearing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'
                        }`}
                    >
                        ...
                        {updateMessage && (
                            <div
                                className="mb-5 p-3 bg-green-50 text-green-700 rounded-lg border border-green-200 flex items-center">
                        ...
                        {updateError && (
                            <div
                                className="mb-5 p-3 bg-red-50 text-red-700 rounded-lg border border-red-200 flex items-center">
                ...
                >
                    <div
                        className={`bg-white rounded-xl shadow-2xl w-full max-w-md p-6 transform transition-all duration-300 ease-in-out ${
                            deleteModalClosing ? 'scale-95 opacity-0' :
                                deleteModalAppearing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'
                        }`}
                    >
                        <div className="flex justify-between items-center mb-5 pb-3 border-b border-gray-100">
            ...
            {showCreateModal && (
                ...
                >
                    <div
                        className={`bg-white rounded-xl shadow-2xl w-full max-w-md p-6 transform transition-all duration-300 ease-in-out ${
                            createModalClosing ? 'scale-95 opacity-0' :
                                createModalAppearing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'
                        }`}
                    >
                        ...
                        {createMessage && (
                            <div
                                className="mb-4 p-3 bg-green-50 text-green-700 rounded-lg border border-green-200 flex items-center">
                                <CheckCircle className="h-5 w-5 mr-2"/>
                                {createMessage}
                            </div>
                        )}
